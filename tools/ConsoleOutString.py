...
consoleout_spec = ["implementation_id", "ConsoleOutString",
                   "type_name",         "ConsoleOutString",
...
class ConsoleOut(OpenRTM_aist.DataFlowComponentBase):
  ...
  def onExecute(self, ec_id):
    if self._inport.isNew():
      ...
      #print data.tm.sec,":",data.tm.nsec,":",data.data
      print data.data
...
def MyModuleInit(manager):
  ...
  # Create a component
  comp = manager.createComponent("ConsoleOutString")
